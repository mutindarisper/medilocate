...
session_start();
//session_destroy();
if (isset($_SESSION['patientSession']) != "") { //session is not empty
header("Location: patient/patient.php"); //store to patient.php
}
if (isset($_POST['login']))//POST collects form data after submitting with method POST
{
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4 col-md-4">
                                                <select name="month" class = "form-control input-lg" required> <!--drop down menu with 12 options(months)-->
                                            ...
                                            <div class="col-xs-4 col-md-4">
                                                <select name="day" class = "form-control input-lg" required> <!--drop down menu with 31 options(days in a month)-->
                                            ...
                                            <div class="col-xs-4 col-md-4">
                                                <select name="year" class = "form-control input-lg" required> <!--drop down menu with 32 options(years)-->
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="input-group" style="margin-bottom:10px;">
                            ...
                            <input class="form-control" id="date" name="date" value="<?php echo date("Y-m-d")?>" onchange="showUser(this.value)"/> <!--get current date when user changes-->
                        </div>
                        ...
                        <script>
                            ...
                            function showUser(str) { //function triggered by the onchange event once the uer changes the year, date and time
                                
                                if (str == "") {   //check if year, month and  date is selected. If no Y-M-D is selected (str == ""), clear the content of txtHint and exit the function
                                    document.getElementById("txtHint").innerHTML = "";
                                    return;
                                } else { 
                                    if (window.XMLHttpRequest) {      /*If a Y-M-D is selected
...
*/
                                    ...
                                    xmlhttp.open("GET","getuser.php?q="+str,true); //the source code in "getuser.php" runs a query against a MySQL database, and returns the result in an HTML table
                                    console.log(str);
                                    xmlhttp.send();
                                }
                            }
